...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 14 11:43:29 2023
...
class Webpage:
    ...
    def layout(self, ticker_list, ticker_data):
        ...
        [
            ...
            dbc.Tabs(
                [
                    dbc.Tab(dcc.Graph(figure=graph_.plot_empty(), id = 'fig'), label="Graph"),
        ...
        def update_graph(ticker, paths, ts, tp, ir, strike):
            ...
            Path = monte_carlo.MonteCarlo().PathGenerator(NoOfPaths, Timesteps, T, r, sigma[0], S0, K)
            
            monte_fig = graph_.add_simulation(Path)
            
            fig = graph_.add_stock(df_ticker, ticker)
